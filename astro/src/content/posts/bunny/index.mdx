...
<div class='pt-6 flex flex-col items-center'>
  <span class='italic font-black text-5xl block'>Bunny<span class='text-[#FA7B27] text-lg tracking-wider'>.net</span></span>
  <span class='text-lg text-neutral-400 block text-center'>vs</span>
  <span class='italic font-black text-5xl block text-center'>Cloudflare Workers</span>
</div>
...
**TL;DR:** Magic Containers is around 50% cheaper on CPU, includes global edge deployment and built-in anycast.
...
**TL;DR:** No verdict yet - Bunny's database is in closed beta with no public pricing.

#### What compelled me to write this?

I saw a post by [@GergelyOrosz](https://x.com/GergelyOrosz) on Bluesky mentioning [@BunnyCDN](https://x.com/BunnyCDN) and searched for it on Hacker News, X, and Bluesky. Everyone's experience was positive, so I spent four hours analyzing it.
