/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dc9d0f6da307e9dcaafbd2cb2a9b2e5e)
// Runtime types generated with workerd@1.20260120.0 2026-01-20 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		VITE_UTTERANCES_LABEL: string;
		VITE_UTTERANCES_REPO: string;
		VITE_UTTERANCES_THEME: string;
		CLOUDFLARE_API_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		VITE_ENABLE_INSPECT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PORT" | "ENVIRONMENT" | "LOGGING" | "CONTEXT7_API_KEY" | "VITE_UTTERANCES_LABEL" | "VITE_UTTERANCES_REPO" | "VITE_UTTERANCES_THEME" | "CLOUDFLARE_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "VITE_ENABLE_INSPECT" | "VITE_ENABLE_CLOUDFLARE_TUNNEL" | "ALLOWED_HOSTS" | "AGENT_DO_KEY">> {}
}
