/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0bc239be02a34d74c56ae926cb0c4996)
// Runtime types generated with workerd@1.20251113.0 2025-10-11 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
  interface Env {
    BASIC_AUTH_USERNAME: 'eng'
    BASIC_AUTH_PASSWORD: 'zealous-mayer'
    PORT: string
    ENVIRONMENT: string
    LOGGING: string
    APP_VERSION: string
